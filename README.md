...
[![JDownloader 2 logo](https://images.weserv.nl/?url=raw.githubusercontent.com/koelle25/docker-templates/master/koelle25/images/jdownloader-2-icon.png&w=110)](http://jdownloader.org)[![JDownloader 2](https://images.placeholders.dev/?width=416&height=110&fontFamily=monospace&fontWeight=400&fontSize=52&text=JDownloader%202&bgColor=rgba(0,0,0,0.0)&textColor=rgba(121,121,121,1))](http://jdownloader.org)
...
```shell
docker pull koelle/jdownloader-2
```
...
For Synology NAS users, follow these steps to update a container image:
  ...
  3.  In the search bar, type the name of the container (`koelle/jdownloader-2`).
...
https://github.com/koelle25/docker-baseimage-gui/raw/master/tools/ssvnc_windows_only-1.0.30-r1.zip
